...
#ifndef INCLUDED_GR_PAPYRUS_INSERT_PREAMBLE_H
#define INCLUDED_GR_PAPYRUS_INSERT_PREAMBLE_H
...
typedef boost::shared_ptr<gr_papyrus_ofdm_insert_preamble> gr_papyrus_ofdm_insert_preamble_sptr;

gr_papyrus_ofdm_insert_preamble_sptr GR_PAPYRUS_API
...
protected:
  gr_papyrus_ofdm_insert_preamble(int fft_length,
              const std::vector<std::vector<gr_complex> > &preamble);
...
public:
  ~gr_papyrus_ofdm_insert_preamble();
  ...
  void GR_PAPYRUS_API reset_preamble(std::vector<std::vector<gr_complex> > new_preamle);
};

#endif /* INCLUDED_GR_PAPYRUS_INSERT_PREAMBLE_H */
